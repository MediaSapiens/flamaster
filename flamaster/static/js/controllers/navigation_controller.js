...
define(['chaplin/controller', 'models/navigation', 'views/navigation_view'], function(Controller, Navigation, NavigationView) {
  'use strict';
  ...
  return NavigationController = (function(_super) {
    ...
    NavigationController.prototype.initialize = function() {
      ...
      return NavigationController.__super__.initialize.apply(this, arguments);
    };
